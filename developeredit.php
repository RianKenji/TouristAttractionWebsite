...
<?php
	...
	if (isset($_POST['edit'])) {
		...
		mysqli_query($connection, "UPDATE developer set developerID = '$developerID',developerNAMA = '$developerNAMA',rilisterbaru = '$rilisterbaru',website = '$website'
			where developerID = '$developerID'");
		header("location:developer.php");
	}
 $kodedevelop = $_GET["ubah"];
 $editdev = mysqli_query($connection, "select * from developer where developerID = '$kodedevelop'");
 $rowedit = mysqli_fetch_array($editdev);
...
<div class="col-sm-10">
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      	<input type="text" class="form-control" id="kk" name="devkode" value="<?php echo $rowedit["developerID"]?>" readonly>
	    </div>
	</div>
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="nk" name="devnama" value="<?php echo $rowedit["developerNAMA"]?>">
	    </div>
	  </div>
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="nk" name="rilis" value="<?php echo $rowedit["rilisterbaru"]?>">
	    </div>
	  </div>
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="nk" name="web" value="<?php echo $rowedit["website"]?>">
	    </div>
	  </div>
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <button type="submit" class="btn btn-primary" values="edit" name="edit">
	      Edit
	      </button>
