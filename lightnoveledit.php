...
if(empty($nama)){
  	mysqli_query($connection, "UPDATE lightnovel SET lnJudul= '$lnjudul' , lnAuthor = '$lnauthor' , lnSynopsis = '$lnsynopsis' , lnIllustrator = '$lnillustrator'  , tahunRilis = '$thnrilis' WHERE lnID = '$lnkode' ");
  ...
  if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
  {
    ...
    mysqli_query($connection, "UPDATE lightnovel SET lnJudul= '$lnjudul' , lnAuthor = '$lnauthor' , lnSynopsis = '$lnsynopsis' , lnIllustrator = '$lnillustrator'  , lnIllust = '$nama' , tahunRilis = '$thnrilis' WHERE lnID = '$lnkode' ");
  	header('location:lightnovel.php');
  }
}
}
 ...
 $kodeln = $_GET["ubah"];
 $editln = mysqli_query($connection, "select * from lightnovel where lnID = '$kodeln'");
 $rowedit = mysqli_fetch_array($editln);
...
<form method="POST" enctype="multipart/form-data">
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kodeln" name="inputkode" value="<?php echo $rowedit["lnID"]?>" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="namahotel" name="inputnama" value="<?php echo $rowedit["lnJudul"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="author" name="author" value="<?php echo $rowedit["lnAuthor"]?>">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="synopsis" name="synopsis" value="<?php echo $rowedit["lnSynopsis"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="illustrator" name="illustrator" value="<?php echo $rowedit["lnIllustrator"]?>">
    </div>
  </div>
    ...
    <div class="form-group row"> 
          ...
          <div class="col-sm-10">
          	...
          	<img src="img/<?php echo $rowedit['lnIllust']?>" style="width: 200px; height: 200px;">
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="tahunrilis" name="tahunrilis" value="<?php echo $rowedit["tahunRilis"]?>">
    </div>
  </div>
