...
<head>
    ...
    <?php 
     ...
     if(isset($_POST["submitlogin"])) {
        ...
        $sql_login = mysqli_query($connection, "SELECT * FROM admin WHERE adminEMAIL = '$emailUser' AND adminPASSWORD = '$passwordUser'");
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <img class="col-lg-6 d-none d-lg-block bg-login-image" src="img/tes1.jpg">
                            <div class="col-lg-6">
                                <div class="p-5">
