...
<?php 
 if(isset($_POST['simpan']))
 {
  ...
  if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
  {
    ...
    mysqli_query($connection, "insert into hotel values ('$hotelkode' , '$hotelnama' , '$hotelalamat' , '$hotelketerangan', '$nama' , '$kodearea')");
...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Hotel">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="hotelket" name="hotelket" placeholder="Keterangan Hotel">
    </div>
  </div>
