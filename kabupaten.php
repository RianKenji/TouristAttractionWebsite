...
<?php 
 if(isset($_POST['simpan']))
 {
  ...
  if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
  {
    ...
    mysqli_query($connection, "insert into kabupaten values ('$kabupatenkode' , '$kabupatennama' , '$alamat' , '$keterangankab' , '$nama' , '$ketfotokabupaten')");
...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Kabupaten">
    </div>
  </div>
  ...
  <div class="form-group row"> 
          ...
          <div class="col-sm-10">
          	<input type="text" class="form-control" id="ketkabupaten" name="ketkabupaten" placeholder="Keterangan">
          </div>
    </div>
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="ketfoto" name="ketfoto" placeholder="Keterangan Photo" >
	    </div>
	 </div>
