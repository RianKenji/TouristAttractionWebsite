 ...
 if(isset($_POST['Edit']))
 {
  ...
  if(!empty($beritakode)){
   ...
   $kodedestinasi = $_POST['kodedestinasi'];
     ...
     mysqli_query($connection,"update berita set beritajudul = '$beritanama', beritainti = '$beritainti', penulis = '$penulisberita', penerbit='$penerbitberita' , tanggalterbit = '$tanggalterbit' , destinasiID = '$kodedestinasi'
...
<form method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inti" name="inti" value="<?php echo $rowedit["beritainti"]?>">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="penulis" name="penulis" value="<?php echo $rowedit["penulis"]?>">
    </div>
  </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="penerbit" name="penerbit" value="<?php echo $rowedit["penerbit"]?>">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="date" class="form-control" id="tanggalterbit" name="tanggalterbit" value="<?php echo $rowedit["tanggalterbit"]?>">
    </div>
  </div>
