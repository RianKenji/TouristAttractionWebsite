...
<?php 
 if(isset($_POST['simpan']))
 {
  ...
  if(!empty($areakode)){
   ...
   mysqli_query($connection, "insert into area values ('$areakode' , '$areanama' , '$alamat', '$areaket' , '$kodekabupaten')");
...
<form method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Wilayah Area">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="keteranganarea" name="keteranganarea" placeholder="Keterangan Area">
    </div>
  </div>
